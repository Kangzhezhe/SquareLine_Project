...
class YOLOv8_face:
    ...
    def detect(self, srcimg):
        ...
        #     outputs = [outputs[2], outputs[0], outputs[1]] ###opencv4.7��Ҫ��һ����opencv4.5����Ҫ
    ...
    def post_process(self, preds, scale_h, scale_w, padh, padw):
        ...
        for i, pred in enumerate(preds):
            ...
            bbox -= np.array([[padw, padh, padw, padh]])  ###����ʹ�ù㲥����
...
if __name__ == '__main__':
    ...
    for i, box in enumerate(boxes):
        ...
        crop_img = srcimg[y:y + h, x:x + w]  ###Ҳ��������������֮����crop
